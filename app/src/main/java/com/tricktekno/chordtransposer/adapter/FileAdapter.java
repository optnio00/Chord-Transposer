package com.tricktekno.chordtransposer.adapter;
...
import com.tricktekno.chordtransposer.R;
...
public class FileAdapter extends ArrayAdapter<CharSequence> {
	...
	public FileAdapter(Context context, List<CharSequence> objects, int checked, boolean multiMode) {
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		Date lastModified = SaveFileHelper.getLastModifiedDate(filename.toString());
